...
public class test implements SQLite.Callback, SQLite.Function,
    ...
    //实现Callback的 columns types newrow方法
    ...
    //重写Function类的function、step、laststep方法
	...
	try {
	    ...
	    System.out.print(db.get_table("select * from persons"));
